...
class DataMobileScreen extends StatefulWidget {
  const DataMobileScreen({super.key});

  @override
  State<DataMobileScreen> createState() => _DataMobileScreenState();
}

class _DataMobileScreenState extends State<DataMobileScreen> {
  @override
  void initState() {
    super.initState();
