...
class SummarizerMobileScreen extends StatelessWidget {
  const SummarizerMobileScreen({super.key});
                      ...
                      ? Column(
                        children: [
                          ...
                          CustomIconFilledBtn(
                            ...
                            onTap: () async {
                              await summarizerTextProvider.summarizeText();
                            },
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      if (summarizerTextProvider.isSpeaking) {
                                        summarizerTextProvider.stopSpeaking();
                                      } else {
                                        summarizerTextProvider.speakSummary();
                                      }
                                    },
                                    child: Chip(
                                      label: Row(
                                        ...
                                        children: [
                                          Icon(
                                            summarizerTextProvider.isSpeaking
                                                ? Icons.stop
                                                : Icons.mic,
